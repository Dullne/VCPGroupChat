...
const TEXT_TRANSLATIONS = new Map(Object.entries({
    ...
    "团队": "Team",
    "工坊": "Studio",
    "人物与模板": "People & Templates",
    "发起群聊": "Start Group Chat",
    "创建并开聊": "Create and Chat",
    "像微信群一样从人物通讯录选择长期人物，确认群名后创建群组并立即开聊。": "Pick long-lived people from the person address book like creating a WeChat group, confirm the group name, then start chatting immediately.",
    "先用一句话生成人物草稿，再保存为长期人物；需要时也能作为当前会话临时角色试用。": "Generate a person draft from one sentence, save it as a long-lived person, and optionally try it as a temporary role in the current session.",
    "这里浏览长期人物、模板和运行时角色。模板先创建人物，运行时角色只做执行和绑定。": "Browse long-lived people, templates, and runtime roles here. Templates create people first; runtime roles are only for execution and binding.",
    "这里浏览长期人物、模板和运行时角色。人物是成员来源，模板用于创建人物，运行时角色只做执行和绑定。": "Browse long-lived people, templates, and runtime roles here. People are the member source, templates create people, and runtime roles only provide execution and binding.",
    "+ 发起群聊": "+ Start Group Chat",
    "群聊": "Group Chats",
    ...
    "团队负责收纳长期人物：先建一个方向，再把相关人物拉进来。日常发起群聊仍从左侧“+ 发起群聊”开始。": "A team collects long-lived people: define a direction first, then pull relevant people in. Daily group chats still start from '+ Start Group Chat' on the left.",
    "1. 团队草稿 / 已有团队": "1. Team Draft / Existing Teams",
    "新团队先进入草稿台，选好人物后一次创建；已有团队仍在这里维护人物池。": "New teams start as drafts: choose people first, then create once. Existing teams manage their person pool here.",
    "新建团队": "New Team",
    "从默认团队复制人物": "Copy People from Default Team",
    "2. 从人物通讯录拉人进团队": "2. Pull People into the Team",
    "2. 先选人物，再创建团队": "2. Pick People, Then Create",
    "搜索人物": "Search People",
    "按人物名 / 标签 / 描述筛选": "Filter by person name / tag / description",
    "标签筛选": "Filter by Tag",
    "这就是团队的主功能：按标签/关键词筛选人物，点“加入这个团队”。已加入的人会固定在上方，作为这个团队的人物池。": "This is the team's main job: filter people by tag or keyword, then click 'Add to this team'. Joined people stay pinned above as this team's person pool.",
    "草稿态下先把人物加入“已选人物”，提交后才会创建新团队；已有团队则直接维护人物池。": "In draft mode, add people to Selected People first; the new team is created only when submitted. Existing teams manage their person pool directly.",
    "创建这个团队": "Create Team",
    "创建团队并加入 0 人": "Create Team and Add 0 Members",
    "更新团队": "Update Team",
    "删除团队": "Delete Team",
    "不会自动继承默认团队；需要时可显式复制默认人物。": "The draft will not inherit the default team automatically; copy default people explicitly if needed.",
    "先选择人物，再创建团队": "Pick people before creating the team",
    "暂无人物描述": "No person description yet",
    "团队草稿：先从右侧选择至少 1 个人物。": "Team draft: select at least 1 person from the right first.",
    "团队草稿：当前没有可选人物。": "Team draft: no selectable people yet.",
    "当前是默认团队：承载系统默认人物池，暂不支持删除与重命名。": "This is the default team: it carries the system default person pool and cannot be deleted or renamed.",
    "当前筛选条件下没有匹配人物。": "No people match the current filters.",
    "当前筛选条件下没有可显示的人物。": "No people to display under the current filters.",
    "还没有可加入团队的长期人物。": "There are no long-lived people that can join the team yet.",
    "填写团队名称后提交，系统会创建团队并加入已选人物。": "Fill in the team name, then submit; the system will create the team and add the selected people.",
    "先从右侧选择人物，草稿不会自动带入默认团队人物。": "Select people from the right first; the draft will not automatically include default-team people.",
    "这个团队还没有说明。先把人物加入团队，日常发起群聊时就能快速筛选候选成员。": "This team has no description yet. Add people to the team so daily group chat creation can quickly filter candidates.",
    "系统默认人物池，保留历史群聊入口与长期人物。": "System default person pool, preserving historical group chat entries and long-lived people.",
    "请先点击「新建团队」，选择人物后再创建": "Click \"New Team\" first, then choose people before creating it.",
    "请先选择至少 1 个团队人物": "Select at least 1 team person first.",
    "默认团队暂时没有可复制人物": "The default team has no people to copy yet.",
    "这是运行时兼容角色，不是长期人物；团队池只移除人物": "This is a runtime compatibility role, not a long-lived person; the team pool only removes people.",
    "团队人物池准备好后，左侧“+ 发起群聊”会更容易选人": "Once the team person pool is ready, '+ Start Group Chat' on the left can pick members faster",
    "1 选成员": "1 Pick Members",
    "2 起群名": "2 Name Group",
    "3 进入聊天": "3 Enter Chat",
    "发起一个新的 AI 群聊": "Start a New AI Group Chat",
    "像微信拉人建群一样：从人物通讯录选成员，起一个群名，然后直接开始对话。": "Like creating a WeChat group: pick members from the person address book, name the group, then start talking.",
    "选择群聊成员": "Select Group Chat Members",
    "从人物通讯录里拉长期人物进群。已选成员会固定显示在上方，点击人物卡片即可加入或移出。": "Pull long-lived people into the group from the person address book. Selected members stay pinned above; click a person card to add or remove.",
    ...
    "已选长期人物会作为群聊成员进入新群聊。运行时角色和 Prompt 编排由系统自动准备。": "Selected long-lived people become members of the new group chat. Runtime roles and prompt orchestration are prepared automatically.",
    ...
    "群组只能从当前团队人物池里选人。团队决定候选人物，群组决定本次谁上场。": "Groups can only choose from the current team person pool. The team defines candidate people; the group decides who joins this chat.",
    ...
    "一句话创建人物": "Create a Person from One Sentence",
    "普通用户不应该手填一堆人物字段。先说一句需求，系统帮你生成人物草稿，再做必要微调。": "Users should not fill a pile of person fields manually. State the need in one sentence, let the system draft the person, then make small edits if needed.",
    "人物工坊生成流水线": "Person Studio Generation Pipeline",
    "PromptX 负责人物结构，agency-agents 负责专业参考，VCP 负责变成可上场人物。": "PromptX handles person structure, agency-agents provides professional references, and VCP turns them into playable people.",
    "工坊不会直接改仓库文件；它会生成一个 VCP 人物草稿，你确认后才保存或加入会话。": "The studio does not edit repository files directly. It generates a VCP person draft and only saves or joins it after you confirm.",
    "描述需求": "Describe Need",
    "一句话说明想补什么人物": "One sentence about the person you need",
    ...
    "保存/上场": "Save / Join",
    "先沉淀长期人物，也可临时上场": "Save as a long-lived person first, or try it temporarily",
    "生成目标：VCP 群聊人物草稿，不会直接创建 PromptX 文件或 agency 仓库角色。": "Generation target: VCP group chat person draft. It will not directly create PromptX files or agency repository roles.",
    "创建范围": "Creation Scope",
    "独立创建人物": "Create Independent Person",
    "为当前群组补位": "Fill Current Group",
    "默认不参考群组或会话，生成可复用的长期人物草稿。": "By default, no group or session is referenced; a reusable long-lived person draft is generated.",
    ...
    "人物生成模型策略": "Person Generation Model Policy",
    "人物运行模型": "Person Runtime Model",
    ...
    "人物运行模型决定对应运行时角色后续发言时调用哪一个模型，留空则走核心默认。": "The person runtime model decides which model the bound runtime role uses when speaking. Leave empty to follow the core default.",
    "生成人物草稿": "Generate Person Draft",
    "清空": "Clear",
    "先输入一句话需求，再生成人物草稿。": "Enter a one-sentence need, then generate a person draft.",
    "草稿预览": "Draft Preview",
    "先确认人物定位、职责和记忆命名是否合理。普通用户到这一步通常就够了。": "First confirm whether person positioning, responsibilities, and memory naming make sense. Most users can stop here.",
    "还没有人物草稿。先输入一句话需求，或展开高级编辑手动创建。": "No person draft yet. Enter a one-sentence need first, or expand advanced editing to create manually.",
    "职责": "Responsibilities",
    "认知草稿": "Cognitive Draft",
    "模板摘要": "Template Summary",
    "创建并加入当前会话": "Create and Join Current Session",
    "保存到人物通讯录": "Save to People Address Book",
    "保存人物并加入当前团队": "Save Person and Add to Current Team",
    "保存人物并加入当前群组": "Save Person and Add to Current Group",
    "展开高级编辑": "Expand Advanced Editing",
    "高级编辑": "Advanced Editing",
    "只有在你需要精细控制运行模型、记忆本命名或运行时模板时，才需要改这里。": "Only edit here when you need precise control over runtime model, memory notebook names, or runtime templates.",
    "人物与模板筛选": "People & Templates Filters",
    "人物通讯录 / 模板目录": "People / Template Catalog",
    "先分清人物、模板和运行时角色，再决定下一步。": "Distinguish people, templates, and runtime roles first, then decide the next step.",
    "人物通讯录优先：长期人物进入团队和群组；模板用于创建人物；运行时角色只做执行和绑定。": "People come first: long-lived people join teams and groups; templates create people; runtime roles only provide execution and binding.",
    "全部来源": "All Sources",
    "临时角色": "Temporary Roles",
    "全部状态": "All Statuses",
    "当前群组成员": "Current Group Members",
    "当前团队成员": "Current Team Members",
    "正在读取人物通讯录和运行时能力。": "Reading the people address book and runtime capabilities.",
    "外部模板目录": "External Template Catalog",
    "刷新目录": "Refresh Directory",
    "这些模板来自 PromptX 和 agency-agents。模板不能直接加入群组；请先创建长期人物，再加入团队或群组。": "These templates come from PromptX and agency-agents. Templates cannot join groups directly; create long-lived people first, then add those people to teams or groups.",
    "当前可用运行时角色": "Currently Available Runtime Roles",
    "这里展示当前会话已可用的运行时角色。只有绑定长期人物后，才能加入团队或群组；临时角色可长期化。": "This shows runtime roles available in the current session. Only roles bound to long-lived people can join teams or groups; temporary roles can be promoted.",
    "当前没有可展示人物或运行时角色。": "No people or runtime roles to show.",
    "当前筛选条件下没有匹配的人物或运行时角色。": "No matching people or runtime roles under the current filters.",
    "先绑定运行时": "Bind Runtime First",
    "运行时已连接的人物可直接加入；缺失或未绑定的人物需要先绑定运行时能力。": "People with connected runtime roles can be added directly; missing or unbound people need runtime binding first.",
    "加载中...": "Loading...",
    "初始化中...": "Initializing...",
    ...
    "请先点击「新建团队」，选择成员后再创建": "Click \"New Team\" first, then choose members before creating.",
    "请先选择至少 1 个团队成员": "Select at least one team member first",
    "默认团队暂时没有可复制成员": "The default team has no members to copy right now",
    "后端没有返回新团队 ID": "The backend did not return the new team ID",
    "群组名称不能为空": "Group name cannot be empty",
    "群组级协作指令不能为空": "Group-level collaboration prompt cannot be empty",
    "人物名称不能为空": "Person name cannot be empty",
    "请先输入一句话人物需求": "Enter a one-sentence person need first",
    ...
    "请先从人物通讯录选择至少 1 个群聊成员": "Select at least one group chat member from the person address book first",
    ...
    "暂时没有可用的团队人物池，请先到“团队”里创建团队并加入长期人物": "No team person pool is available yet. Create a team and add long-lived people under Team first.",
    ...
    "待绑定运行时人物": "People needing runtime binding",
    "已确认": "Confirmed",
    ...
    "还没有角色参与状态。": "No participant states yet.",
    "还没有本轮记忆沉淀。": "No memory deposition for this round yet.",
    "当前会话没有项目资产沉淀。": "No project assets deposited in this session.",
    "选择运行时角色": "Select runtime role",
    "需要先绑定运行时角色": "A runtime role needs to be bound first",
    "这些长期人物缺少可用运行时角色；绑定或生成后才能上场发言。": "These long-lived people are missing usable runtime roles. Bind or generate one before they can speak.",
    "一键生成缺失运行时": "Generate Missing Runtime Roles",
    "待补全人物档案": "People needing profile enrichment",
    "档案较薄": "Sparse profile",
    "缺少人物定位、性格或表达风格": "Missing positioning, personality, or voice style",
    "这些长期人物已有身份，但缺少可用于群聊发言的性格、情绪或表达档案。": "These long-lived people already exist, but their personality, emotion, or voice profile is too sparse for group chat.",
    "一键补全人物档案": "Enrich Person Profiles",
    "补全档案": "Enrich Profile",
    "后端人物生成暂时不可用，已使用本地人物草稿兜底。建议先改一个更具体的人物名，再创建人物。": "Backend person generation is temporarily unavailable; a local person draft fallback was used. Set a more specific person name, then create the person.",
    ...
    "当前团队还没有人物，请先在上方“团队拉人”中拉入长期人物。": "The current team has no people yet. Add long-lived people in Team Pull above first.",
    "运行时角色为空，无法配置团队成员。": "Runtime roles are empty, so team members cannot be configured.",
    ...
    "团队草稿": "Team Draft",
    "先选择成员，再创建团队": "Pick members before creating the team",
    "不会自动继承默认团队；需要时可显式复制默认成员。": "The default team is not inherited automatically; copy default members explicitly when needed.",
    "填写团队名称后提交，系统会创建团队并加入已选成员。": "Submit after naming the team; the system will create it and add the selected members.",
    "先从右侧选择成员，草稿不会自动带入默认团队成员。": "Select members on the right first; drafts do not automatically import default-team members.",
    "团队草稿：先从右侧选择至少 1 个成员。": "Team draft: select at least one member on the right.",
    "团队草稿：当前没有可选角色。": "Team draft: no selectable roles right now.",
    "已选成员": "Selected Members",
    "可加入成员": "Available Members",
    "这些成员会随新团队一起创建，可在提交前继续移出或补充。": "These members will be created with the new team; remove or add more before submitting.",
    "点击“加入草稿”，先把成员放进新团队草稿。": "Click 'Add to draft' to place the member into the new-team draft first.",
    "还没选择成员。至少选 1 个长期人物才能发起群聊。": "No members selected yet. Select at least one long-lived person to start a group chat.",
    "人物通讯录为空，暂时不能发起群聊。": "The person address book is empty, so group chat cannot start yet.",
    "当前筛选条件下没有匹配的群聊配置。": "No group chat configurations match the current filters.",
    "当前会话暂无运行时角色": "No runtime roles in the current session yet",
    "当前没有可展示运行时角色。": "No runtime roles to display.",
    "当前筛选条件下没有匹配的可用运行时角色。": "No available runtime roles match the current filters.",
    "当前没有可用的外部模板目录": "No external template catalogs are available",
    "当前没有可用的外部模板目录。": "No external template catalogs are available.",
    ...
    "当前没有可参考模板。": "No reference templates are available.",
    "人物模板": "Person Template",
    "运行时角色": "Runtime Role",
    "运行时角色列表": "Runtime Role List",
    "运行时来源": "Runtime Source",
    "类型 运行时角色": "Type Runtime Role",
    "外部模板不能直接加入群组；请先从模板创建长期人物，再把人物加入群组。": "External templates cannot join groups directly; create a long-lived person from the template first, then add that person to the group.",
    ...
    "正在生成独立人物草稿...": "Generating an independent person draft...",
    "正在参考当前群组生成补位人物草稿...": "Generating a fill-in person draft using the current group...",
    "还没有明确职责。建议补一句更具体的人物需求。": "No clear responsibilities yet. Add a more specific person need.",
    "暂无人物说明": "No person description yet",
    ...
    "群组成员": "Group Member",
    "已长期化": "Promoted",
    "长期人物": "Long-lived Person",
    "可加入的角色": "Roles you can add",
    "运行时已连接": "Runtime connected",
    "运行时缺失": "Runtime missing",
    "未绑定运行时": "Runtime unbound",
    "模板来源": "Template source",
    "兼容角色": "Compatible role",
    "仅点名": "Mention Only",
    "后端实绩": "Backend Result",
    "手动点名": "Manual Mention",
    "@点名": "@Mention",
    ...
    "可加入的人物": "People you can add",
    "这些人物已经在团队人物池里，可以继续从下方补人，或移出团队。": "These people are already in the team person pool. Add more from below or remove them from the team.",
    "点击“加入这个团队”，把人物放进当前团队人物池。": "Click 'Add to this team' to place the person into the current team person pool.",
    "未挂载": "Not Mounted",
    ...
    "像微信群一样选择长期人物并开聊": "Pick long-lived people and start chatting like WeChat",
    ...
    "按人物名 / 标签 / 描述搜索": "Search by person name / tag / description",
    ...
    "例如：帮我创建一个既懂产品又懂代码、负责拆解需求和推进交付的人物。": "Example: Create a person who understands product and code, breaks down requirements, and drives delivery.",
    ...
    "人物简介": "Person brief",
    "人物定位 / 认知描述": "Person positioning / cognitive description",
    "职责范围，每行一条": "Responsibilities, one per line",
    "补充模板或系统提示核心内容": "Supplemental template or core system prompt content",
    "搜索运行时角色名 / 标签 / 描述 / 来源": "Search runtime role name / tag / description / source",
    "按来源筛选角色": "Filter roles by source",
    "按状态筛选人物与运行时角色": "Filter people and runtime roles by status",
...
const PATTERN_TRANSLATIONS = [
    ...
    [/^(.+) · (\d+) 名成员$/, match => `${translateTrimmedText(match[1], EN_LOCALE)} · ${match[2]} members`],
    [/^(\d+)\/(\d+) 个角色$/, match => `${match[1]}/${match[2]} roles`],
    [/^(\d+) 个角色 · (\d+) 个历史群聊配置$/, match => `${match[1]} roles · ${match[2]} historical group configs`],
    [/^(.+) · (\d+) 个角色 · (\d+) 个历史群聊配置$/, match => `${translateTrimmedText(match[1], EN_LOCALE)} · ${match[2]} roles · ${match[3]} historical group configs`],
    [/^(\d+) 个人物 · (\d+) 个历史群聊配置$/, match => `${match[1]} people · ${match[2]} historical group configs`],
    [/^(.+) · (\d+) 个人物 · (\d+) 个历史群聊配置$/, match => `${translateTrimmedText(match[1], EN_LOCALE)} · ${match[2]} people · ${match[3]} historical group configs`],
    [/^待补全人物档案 · (\d+)$/, match => `People needing profile enrichment · ${match[1]}`],
    ...
    [/^当前团队：(.+) · 当前群组：(.+)。从团队人物池中拉人入群或移出。$/, match => `Current team: ${match[1]} · current group: ${match[2]}. Pull people from the team person pool into the group or remove them.`],
    ...
    [/^已选择 (\d+) 个成员。选好后在右侧填写群名，系统会自动准备运行时能力。$/, match => `${match[1]} members selected. Fill in the group name on the right; the system will prepare runtime capabilities.`],
    ...
    [/^当前可快速切换 (\d+) 个运行模型。留空表示不在人物上绑定模型。$/, match => `${match[1]} runtime models are available for quick switching. Leave blank to avoid binding a model to the person.`],
    ...
    [/^运行时角色列表 (\d+)$/, match => `Runtime Role List ${match[1]}`],
    ...
    [/^已创建临时角色「(.+)」。如需长期保留，可在人物与模板中执行长期化。$/, match => `Temporary role "${match[1]}" created. Promote it in People & Templates if it should be kept long-term.`],
    [/^模板「(.+)」不能直接创建群组；请先创建长期人物，再从人物加入团队或群组。$/, match => `Template "${match[1]}" cannot create a group directly; create a long-lived person first, then add the person to a team or group.`],
    ...
    [/^创建团队并加入 (\d+) 人$/, match => `Create Team and Add ${match[1]} ${Number(match[1]) === 1 ? 'Member' : 'Members'}`],
    [/^已选 (\d+) 个成员$/, match => `${match[1]} members selected`],
    [/^已选 (\d+) 个人物$/, match => `${match[1]} people selected`],
    [/^(\d+) 个人物$/, match => `${match[1]} people`],
    [/^(.+) · (\d+) 个人物$/, match => `${translateTrimmedText(match[1], EN_LOCALE)} · ${match[2]} people`],
    [/^团队草稿 · 已选 (\d+) 个成员$/, match => `Team Draft · ${match[1]} members selected`],
    [/^团队草稿 · 已选 (\d+) 个人物$/, match => `Team Draft · ${match[1]} people selected`],
    [/^团队草稿：已选 (\d+) 个成员，填写名称后创建。$/, match => `Team draft: ${match[1]} members selected. Fill in the name, then create.`],
    [/^团队草稿：已选 (\d+) 个人物，填写名称后创建。$/, match => `Team draft: ${match[1]} people selected. Fill in the name, then create.`],
    [/^团队草稿：已选 (\d+) 个成员，先选人再创建团队。$/, match => `Team draft: ${match[1]} members selected. Pick members before creating the team.`],
    [/^团队草稿：已选 (\d+) 个人物，先选人再创建团队。$/, match => `Team draft: ${match[1]} people selected. Pick people before creating the team.`],
    [/^团队草稿：已选 (\d+) 个成员，可选 (\d+) 个；当前标签：(.+)。$/, match => `Team draft: ${match[1]} members selected, ${match[2]} available; current tag: ${match[3]}.`],
    [/^团队草稿：已选 (\d+) 个人物，可选 (\d+) 个；当前标签：(.+)。$/, match => `Team draft: ${match[1]} people selected, ${match[2]} available; current tag: ${match[3]}.`],
    [/^当前团队：(.+)。已加入 (\d+) 个人物，可按标签或关键词筛选后加入。$/, match => `Current team: ${match[1]}. ${match[2]} people joined; filter by tag or keyword before adding more.`],
    [/^当前团队：(.+)。已加入 (\d+) 个人物，可选 (\d+) 个；当前标签：(.+)。$/, match => `Current team: ${match[1]}. ${match[2]} people joined, ${match[3]} available; current tag: ${match[4]}.`],
    [/^已从默认团队复制 (\d+) 个成员到草稿$/, match => `${match[1]} default-team members copied into the draft`],
    [/^已从默认团队复制 (\d+) 个人物到草稿$/, match => `${match[1]} default-team people copied into the draft`],
    [/^人物「(.+)」还没有连接运行时角色$/, match => `Person "${match[1]}" is not connected to a runtime role yet`],
    [/^长期人物 (\d+)$/, match => `Long-lived people ${match[1]}`],
    [/^人物通讯录已有 (\d+) 个长期人物，但都需要先绑定可用运行时角色后才能开聊。$/, match => `The people address book has ${match[1]} long-lived people, but all need a usable runtime role before starting a chat.`],
    ...
    // Person draft fallback with name.
    [/^后端模型接口未配置（GROUPCHAT_LLM_BASE_URL），已使用本地人物草稿兜底。配置 GroupChatBackend 的模型地址后可使用后端人物生成：(.+)。当前草稿可继续创建。$/, match => `Backend model endpoint is not configured (GROUPCHAT_LLM_BASE_URL); used a local person draft fallback: ${match[1]}. Configure the GroupChatBackend model base URL to use backend person generation. You can continue with the current draft.`],
    [/^后端模型接口未配置（GROUPCHAT_LLM_BASE_URL），已使用本地人物草稿兜底。配置 GroupChatBackend 的模型地址后可使用后端人物生成。建议先改一个更具体的人物名，再创建人物。$/, () => 'Backend model endpoint is not configured (GROUPCHAT_LLM_BASE_URL); used a local person draft fallback. Configure the GroupChatBackend model base URL to use backend person generation. Set a more specific person name, then create the person.'],
    [/^后端人物生成请求超时，已使用本地人物草稿兜底：(.+)。当前草稿可继续创建。$/, match => `Backend person generation timed out; used a local person draft fallback: ${match[1]}. You can continue with the current draft.`],
    [/^后端人物生成请求超时，已使用本地人物草稿兜底。建议先改一个更具体的人物名，再创建人物。$/, () => 'Backend person generation timed out; used a local person draft fallback. Set a more specific person name, then create the person.'],
    [/^后端人物生成返回错误，已使用本地人物草稿兜底：(.+)：(.+)。当前草稿可继续创建。$/, match => `Backend person generation returned an error; used a local person draft fallback: ${match[2]}. Error: ${match[1]}. You can continue with the current draft.`],
    [/^后端人物生成暂时不可用，已使用本地人物草稿兜底：(.+)。检查后可继续创建。$/, match => `Backend person generation is temporarily unavailable; used a local person draft fallback: ${match[1]}. Review, then continue creating.`],
    [/^后端人物生成暂时不可用，已使用本地人物草稿兜底：(.+)。当前草稿可继续创建。$/, match => `Backend person generation is temporarily unavailable; used a local person draft fallback: ${match[1]}. You can continue with the current draft.`],
    ...
    // Person Studio: draft meta badges, memory preview, model options, sources.
    [/^私有记忆：(.+)$/, match => `Private memory: ${match[1]}`],
    [/^知识记忆：(.+)$/, match => `Knowledge memory: ${match[1]}`],
    [/^人物固定模型：(.+)$/, match => `Person fixed model: ${match[1]}`],
    ...
    [/^参考群组：(.+)。生成时会参考群组章程和已在场人物，用来补位。$/, match => `Reference group: ${match[1]}. Generation will use the group charter and current participants to fill a missing person.`],
    [/^参考范围：未参考群组(?:（本地兜底未参考群组）)?$/, match => match[0].includes('本地兜底') ? 'Reference scope: no group used (local fallback did not use group context).' : 'Reference scope: no group used.'],
    [/^参考范围：不参考群组或会话，生成可复用的长期人物草稿。$/, () => 'Reference scope: no group or session is used; generates a reusable long-lived person draft.'],
    [/^参考范围：群组「(.+)」(?: · 已参考 (\d+) 个已有人物)?$/, match => `Reference scope: group "${match[1]}"${match[2] ? ` · referenced ${match[2]} existing people` : ''}`],
    ...
    [/^当前后端可用 (\d+) 个人物生成模型(?:（(.+)）)?。稍后可以临时覆盖模型或指定固定模型。$/, match => `${match[1]} person generation models available from backend${match[2] ? ` (${match[2]})` : ''}. Override temporarily or assign a fixed model later.`],
    [/^当前人物将固定使用：(.+)$/, match => `This person will be fixed to: ${match[1]}`],
    ...
    [/^已保存人物「(.+)」到(.+)。$/, match => `Person "${match[1]}" saved to ${translateTrimmedText(match[2], EN_LOCALE)}.`],
    [/^已创建团队：(.+)，但 (\d+) 个成员加入失败$/, match => `Team created: ${match[1]}, but ${match[2]} members failed to join`],
    [/^已创建团队：(.+)，但 (\d+) 个人物加入失败$/, match => `Team created: ${match[1]}, but ${match[2]} people failed to join`],
    [/^已创建团队：(.+)，已加入 (\d+) 个成员$/, match => `Team created: ${match[1]}; ${match[2]} members joined`],
    [/^已创建团队：(.+)，已加入 (\d+) 个人物$/, match => `Team created: ${match[1]}; ${match[2]} people joined`],
    [/^已创建团队：(.+)$/, match => `Team created: ${match[1]}`],
    [/^已删除团队：(.+)$/, match => `Team deleted: ${match[1]}`],
    [/^已更新团队：(.+)$/, match => `Team updated: ${match[1]}`],
    [/^团队名称已存在，已切换到「(.+)」，草稿成员未自动加入$/, match => `Team name already exists; switched to "${match[1]}". Draft members were not added automatically.`],
    [/^团队名称已存在，已切换到「(.+)」，草稿人物未自动加入$/, match => `Team name already exists; switched to "${match[1]}". Draft people were not added automatically.`],
    ...
    [/^确认删除群聊配置「(.+)」吗？此操作不会删除运行时角色，但会删除这套业务编排模板。$/, match => `Delete group chat configuration "${match[1]}"? This will not delete runtime roles, but it will delete this business orchestration template.`]
];
