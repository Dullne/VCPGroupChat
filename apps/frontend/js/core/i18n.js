...
const TEXT_TRANSLATIONS = new Map(Object.entries({
    ...
    "新团队先进入草稿台，选好成员后一次创建；已有团队仍在这里维护成员池。": "New teams start as drafts: choose members first, then create once. Existing teams still manage their member pool here.",
    "新建团队": "New Team",
    "从默认团队复制成员": "Copy Members from Default Team",
    "2. 从角色库拉人进团队": "2. Pull Roles into the Team",
    "2. 先选成员，再创建团队": "2. Pick Members, Then Create",
    "搜索角色": "Search Roles",
    "标签筛选": "Filter by Tag",
    ...
    "草稿态下先把成员加入“已选成员”，提交后才会创建新团队；已有团队则直接维护成员池。": "In draft mode, add members to Selected Members first; the new team is created only when submitted. Existing teams manage their member pool directly.",
    "创建这个团队": "Create Team",
